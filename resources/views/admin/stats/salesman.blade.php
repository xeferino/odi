...
@section('title', 'Estadísticas de los vendedores')
@section('styles')
...
<div class="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-6">
                <select class="select2 form-control custom-select" style="height:36px;" id="seller">
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.stats.salesman.data') }}",
                data: (data) => {
